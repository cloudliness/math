...
# 2. Ask for a math plot
payload = {
    "session_id": session_id,
    "message": "Plot the function f(n) = n^2 and mark the point (2, 4)"
}
...
if data.get("mafs_data"):
    print("SUCCESS: Mafs JSON extracted successfully!")
else:
    print("FAILED: mafs_data is null")
